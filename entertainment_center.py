...
avatar = Movie("Avatar",
               "A marine on an alien planet tries to save the aliens.",
               "https://upload.wikimedia.org/wikipedia/en/b/b0/Avatar-Teaser-Poster.jpg",  # noqa
               "https://www.youtube.com/watch?v=5PSNL1qE6VY")

fight_club = Movie("Fight Club",
                   """"
                   A man fights back against the soul crushing american
                   society.
                   """,
...
hunger_games = Movie("Hunger Games",
                     """
                     A women enter a competition to fight to the death with
                     other people.
                     """,
...
wreck_it_ralph = Movie("Wreck it Ralph",
                       """
                       A video game character fights to save other video game
                       characters.
                       """,
